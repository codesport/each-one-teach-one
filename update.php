...
?>
        ...
        <title>Update Your Account | Each One, Teach One</title>
    </head>
    <body>
            ...
            <form id="student-data" class="needs-validation" novalidate>
                <div class="form-row">
                    <div class="col mb-3">
                        ...
                        <input type="text" class="form-control" id="first-name" placeholder="First Name" name="first_name"  value="<?php echo $results['data'][0][6]['value'];?>" required>
                        <div id="first_name-feedback" class="invalid-feedback"></div>  
                    </div>

                    <div class="col mb-3">
                        <label class="sr-only" for="preferred-name">Preferred Name</label>
                        <input type="text" class="form-control" id="preferred-name" placeholder="Preferred Name (optional)" name="nick_name" value="<?php echo $results['data'][0][7]['value'];?>">
                    </div>

                    <div class="col mb-3">
                        <label class="sr-only" for="last-name">Last name</label>
                        <input type="text" class="form-control" id="last-name" placeholder="Last Name(s)" name="last_name" value="<?php echo $results['data'][0][8]['value'];?>" required>
                ...
                <div class="form-row">
                    <div class="col col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="city"  placeholder="City" name="city" value="<?php echo $results['data'][0][10]['value'];?>" required>
                        <div id="city-feedback" class="invalid-feedback"></div>
                    </div>

                    <div class="col col-md-4 mb-3">
                        <label class="sr-only" for="state">State</label>
                        <input list="state-list" class="form-control" placeholder="Select a State" id="state" name="state" required value="<?php echo $results['data'][0][11]['value'];?>">
                    ...
                    <div class="col col-md-2 mb-3">
                        ...
                        <input type="text" class="form-control" id="zipcode" type="number" placeholder="zip code" name="zipcode" value="<?php echo $results['data'][0][12]['value'];?>" required>
                ...
                <div class="form-row">
                    <div class="col mb-3">
                            ...
                            <input type="email" class="form-control" id="email" placeholder="name@example.com" name="email" value="<?php echo $results['data'][0][9]['value'];?>" required>
                            <div id="email-feedback" class="invalid-feedback"></div>
                    </div>

                    <div class="col mb-3">
                        <label class="sr-only" for="phone">Phone Number</label>
                        <input class="form-control" id="phone" placeholder="mobile number (optional)" name="phone" minlength="10" value="<?php echo $results['data'][0][13]['value'];?>" required>
                ...
                <div class="form-row">
                    <div class="col-auto mb-3">
                        <button id="change-password" type="button" class="btn btn-success">Update Password</button>
                    </div>
                    <div class="password-container col mb-3 d-none">
                        <label class="sr-only" for="password-initial">Password</label>
                        <input type="password" class="form-control password" id="password-initial" name="password" placeholder="password">
                        <div id="password-feedback" class="invalid-feedback"></div>
                    </div>
                    <div class="password-container col mb-3 d-none">
                        <label class="sr-only" for="password-verify">Verify Password</label>
                        <div class="input-group mb-2">
                            <input type="password" class="form-control password" id="password-verify" name="password_verify" placeholder="verify password">
...
<!--
                <div class="form-group">
                    ...
                    <select multiple class="form-control" id="emerging-tech" name="emerging_tech[]" required>
                        ...
                        <?php #endif ?>
                        <?php# if ( !in_array( 'None of the above', $engineering_array ) ) : ?>    
                            <option value="None of the above">None of the above</option>
                        <?php #endif ?>                            
                    </select>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="feedack" rows="3" name="feedback" placeholder="Pro Tip: Including keywords (e.g., carpentry, football, HIIT, basketball, or weightlifting) allows us to automatch you"><?php if (empty($results['data'][0][14]['value']) ) ''; else echo $results['data'][0][14]['value']; ?></textarea>
                </div>
 ...
 <?php else : ?>
    ...
    <h2>Please <a href="login.php">login</a> to access this form</h2>
<?php endif ?>
</div>
</div>
...
//https://www.w3schools.com/jquery/html_toggleclass.asp
   $('.input-group-append').on('click', function() {
    ...
    $('#change-password').click( function(){
        ...
        if ( $('#change-password').text() == 'Update Password' ){

            $('#change-password').text('Keep Old Password')
            console.log(  $('#change-password').text() )
            $('#password-initial').attr('required', true)
            $('#password-verify').attr('required', true)

        }else{

            $('#change-password').text('Update Password')
            $('#password-initial').attr('required', false)
            $('#password-verify').attr('required', false)
            ...
            if ( errors == 0 ){
               ...
               //TODO: Delete when in production               
                ...
                .always( function(){
                    ...
                    document.title = '<?php echo $_SESSION["name"] ?>' + ' \'s Update Page ' + new Date($.now())
