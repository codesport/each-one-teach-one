...
<?php if ( !isset($_SESSION['user_id']) ) : ?>
            ...
            <form id="login" class="needs-validation" novalidate>
                ...
                <button id="submitButton" class="btn btn-primary" type="submit">Login</button>
            </form>
    <?php else : ?>

        </div>

    <h4>Hello, you're already logged in. Visit the <a href="logout.php">logout page</a> to proceed.</h4>
